...
const AiInvestigation = () => {
  ...
  const handleAnswer = async (answerValue) => {
    const newAnswers = [
      ...answers,
      { question: currentQuestion.text, answer: answerValue },
    ];
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      try {
        ...
        alert(
          "Failed to generate final complaint. Gemini API might be busy. Please try answering again.",
        );
          ...
          {isFinalizing && (
            <div className="absolute inset-0 bg-gray-900/80 backdrop-blur-sm z-10 flex flex-col items-center justify-center">
              ...
              <p className="text-gray-300">
                Drafting the perfect professional complaint for the authorities.
              </p>
              ...
              <div className="flex gap-4">
                ...
                <div className="bg-gray-700 p-4 rounded-2xl rounded-tl-none text-gray-200">
                  ...
                  <p className="mt-2 text-sm text-gray-300">
                    I detected: <strong>{investigationData.issueType}</strong> (
                    {investigationData.confidence} confidence)
                  </p>
                  <p className="mt-2">
                    I've analyzed your image and would like to ask a few
                    questions to help the local authority resolve this issue
                    faster.
                  </p>
                </div>
              </div>
              ...
              {answers.map((ans, i) => (
                <div key={i} className="space-y-4">
                  ...
                  <div className="flex gap-4 justify-end">
                    <div className="bg-white text-black p-4 rounded-2xl rounded-tr-none ">
                      <p>{ans.answer}</p>
                    </div>
                    <div className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-xl flex-shrink-0">
                      👤
              ...
              <div className="pt-4 border-t border-gray-700">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {currentQuestion.options?.map((opt) => (
                      <button
                        ...
                        className="bg-gray-700 hover:bg-gray-600 text-white py-3 px-4 rounded-lg font-medium transition-colors border border-gray-600 text-left"
                      >
                        {opt}
                      </button>
                    ))}
                ...
                {currentQuestion.type === "Short Text" && (
                  <form onSubmit={handleTextSubmit} className="flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="bg-white text-black hover:bg-gray-200 px-6 py-3 rounded-lg font-bold transition-colors"
                    >
                      Send
                    </button>
                  </form>
        ...
        <div className="bg-gray-800 p-6 md:p-8 rounded-xl shadow-lg border-t-4 border-green-500 flex flex-col h-full animate-fadeIn">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/3">
              <img
                src={investigationData.imageUrl}
                alt="Issue"
            ...
            >
              ...
              <div>
                ...
                <textarea
                  name="description"
                  value={finalComplaint.description}
                  onChange={handleInputChange}
                  className="w-full min-h-[120px] bg-gray-700 text-white p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    name="department"
                    value={finalComplaint.department}
                    onChange={handleInputChange}
                    className="w-full bg-gray-700 text-white p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  value={finalComplaint.estimatedImpact || ""}
                  onChange={handleInputChange}
                  className="w-full bg-gray-700 text-white p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-red-300 font-medium"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  value={finalComplaint.recommendedAction || ""}
                  onChange={handleInputChange}
                  className="w-full min-h-[80px] bg-gray-700 text-white p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-300 font-medium"
                />
              </div>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full py-4 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl shadow-lg transition-all text-lg flex justify-center items-center gap-2"
                >
