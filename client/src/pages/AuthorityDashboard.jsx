  ...
  return (
    <div className="container mx-auto p-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="/authority-analytics" className="bg-white text-black hover:bg-gray-200 px-4 py-2 rounded font-medium transition-colors">
          View Analytics
        </Link>
      </div>

      {/* AI Executive Brief */}
      <div className="mb-10 bg-gray-900 border border-gray-700 rounded-2xl p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex justify-between items-start mb-6 relative z-10">
          ...
          <button 
            ...
            className="bg-white text-black hover:bg-gray-200 px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center gap-2 shadow-lg shadow-none"
          >
            {generatingBrief ? (
        ...
        {executiveBrief ? (
          <div className="relative z-10 space-y-6">
            ...
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
              <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-2">Strategic Recommendation</h4>
              <p className="text-gray-300 font-medium text-lg italic">"{executiveBrief.recommendation}"</p>
            </div>
        ...
        <div>
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 space-y-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-white font-bold text-xl">{citizenSat}</span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 flex justify-between items-center">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-xl">🛣️</div>
                <div>
