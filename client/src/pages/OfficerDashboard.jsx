    ...
    <div className="container mx-auto p-4 py-8 max-w-6xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow flex flex-col items-center justify-center">
          <span className="text-4xl font-bold text-white mb-2">{stats.Reported}</span>
            ...
            <div key={complaint._id} className="bg-gray-800 rounded-xl overflow-hidden shadow border border-gray-700 flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 border-t border-gray-700">
                  <Link to={`/officer-complaint/${complaint._id}`} className="block text-center w-full bg-white text-black hover:bg-gray-200 py-2 rounded transition-colors text-sm font-bold shadow">
                    Manage Complaint
                  </Link>
                </div>
              </div>
